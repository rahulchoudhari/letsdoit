...
#  enable_classiclink   = "false" # With the retirement of EC2-Classic the enable_classiclink attribute has been deprecated and will be removed in a future version

  tags = {
    Name = "${var.environment}_sbx_vpc"
  }
}
